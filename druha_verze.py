...
class Spaceship(All_objects):
    ...
    def __init__(self, x=None, y=None, x_speed=None, y_speed=None,
                 rotation=None):
...
class Meteor(All_objects):
    ...
    def __init__(self, x=None, y=None, img_file=None, x_speed=None,
                 y_speed=None, rspeed=None):
...
class Actions():
    ...
    def tick(self, dt):
        ...
        for meteor in self.meteors:
            ...
            for laser in self.lasers:
                laser.tick(dt)
                distance2 = (
                    (meteor.x - laser.x)**2 + (meteor.y - laser.y)**2)**0.5
    ...
    def colision(self):
        ...
        pyglet.clock.schedule_once(self.reset, 3)
